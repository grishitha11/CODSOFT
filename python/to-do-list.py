...
class todo:
    def  __init__(self, root):
        ...
        self.root.geometry("680x430+310+160")

        self.label1= Label(self.root, text='To-Do-List-App',font='ariel, 25 bold', width =10,bd=5,bg='purple',fg='white')
        self.label1.pack(side='top',fill=BOTH)

        self.label2 = Label(self.root, text='Add Task',font='ariel, 18 bold', width =10,bd=5,bg='purple',fg='white')
        self.label2.place(x=40, y=54)
        
        self.label3 = Label(self.root, text='Tasks',font='ariel, 18 bold', width =10,bd=5,bg='purple',fg='white')
        ...
        self.button = Button(self.root, text='Add', font='sarif, 20 bold italic',
                    width=10,bd=5, bg='purple', fg='white', command=add)
        self.button.place(x=30, y=180)
        
        self.button2 = Button(self.root, text='Delete', font='sarif, 20 bold italic',
                    width=10,bd=5, bg='purple', fg='white', command=delete)
